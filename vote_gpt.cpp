...
public:
    ...
    void displayCandidates() {
        ...
        for (size_t i = 0; i < candidates.size(); ++i) {
            cout << "| " << setw(3) << i + 1 << " | " << setw(35) << left << candidates[i].name << " | " 
                 << setw(35) << left << candidates[i].party << " | " << setw(20) << left << candidates[i].symbol << " |\n";
        }
        cout << "----------------------------------------------------------------------------------------------------------\n";
    }
    ...
    void displayResults() {
        ...
        for (const auto& candidate : candidates) {
            cout << "| " << setw(30) << left << candidate.name << " | " << setw(35) << left << candidate.party << " | " << setw(5) << candidate.votes << " |\n";
        }
        cout << "--------------------------------------------------------------------------------\n";
    }
