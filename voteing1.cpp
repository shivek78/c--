...
class SystemDisplay {
public:
    void selectOption(); // Renamed from 'select' to 'selectOption'
...
private:
    ...
    void displayResult(Voting& voting);
};

void SystemDisplay::selectOption() { // Renamed from 'select' to 'selectOption'
    static Voting v1;  // Create a single instance of Voting for the whole program
    Admin a1;
    char choose;
...
void Admin::admin() {
    ...
    if (inputPassword == password) {
        adminSection(Voting()); // Use the persistent Voting instance
    } else {
...
void Admin::displayResult(Voting& voting) {
